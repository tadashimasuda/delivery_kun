                          ...
                          Form(
                            child: Column(
                                ...
                                children: <Widget>[
                                  ...
                                  Column(
                                    children: ValidateEmail(
                                        auth.validate_message),
                                  ),
                                  SizedBox(
                                    height: 20,
                                  ),
...
class SocialSignInButton extends StatelessWidget {
  SocialSignInButton(
      {required this.backgroundColor, required this.textColor, required this.title, required this.image});
