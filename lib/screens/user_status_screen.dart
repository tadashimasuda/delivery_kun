        ...
        body: Consumer<Auth>(
            builder: (context, auth, child) => auth.authenticated
                ? LoggedInUserStatus(
                    ...
                    hasSubscription: _hasSubscribed,
                  )
                : const SignUpForm()),
...
class LoggedInUserStatus extends StatefulWidget {
  LoggedInUserStatus({required this.user_id, required this.hasSubscription});
...
class _LoggedInUserStatusState extends State<LoggedInUserStatus> {
  ...
  Widget build(BuildContext context) {
    ...
    bool _hasSubscription = widget.hasSubscription;
